                          ...
                          {relatedStatus && (
                            <div className="mt-4 pt-4 border-t border-orange-300">
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                                {relatedStatus.courseware_exam_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">Courseware Exam:</span>
                                    <p className="text-gray-600 mt-1">{relatedStatus.courseware_exam_status}</p>
                                  </div>
                                )}
                                {relatedStatus.degree_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">Degree:</span>
                                    <p className="text-gray-600 mt-1">{relatedStatus.degree_status}</p>
                                  </div>
                                )}
                                {relatedStatus.enrolment_no_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">Enrolment No.:</span>
                                    <p className="text-gray-600 mt-1">{relatedStatus.enrolment_no_status}</p>
                                  </div>
                                )}
                                {relatedStatus.exam_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">Exam:</span>
                                    <p className="text-gray-600 mt-1">{relatedStatus.exam_status}</p>
                                  </div>
                                )}
                                {relatedStatus.lor_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">LOR:</span>
                                    <p className="text-gray-600 mt-1">{relatedStatus.lor_status}</p>
                                  </div>
                                )}
                                {relatedStatus.ms_hard_copy_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">MS Hard Copy:</span>
                                    <p className="text-gray-600 mt-1">{relatedStatus.ms_hard_copy_status}</p>
                                  </div>
                                )}
                                {relatedStatus.ms_hard_copy_courier_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">MS Hard Copy Courier:</span>
                                    <p className="text-gray-600 mt-1">{relatedStatus.ms_hard_copy_courier_status}</p>
                                  </div>
                                )}
                                {relatedStatus.ms_scan_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">MS SCAN:</span>
                                    <p className="text-gray-600 mt-1">{relatedStatus.ms_scan_status}</p>
                                  </div>
                                )}
                                {relatedStatus.provisional_degree_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">Provisional Degree:</span>
                                    <p className="text-gray-600 mt-1">{relatedStatus.provisional_degree_status}</p>
                                  </div>
                                )}
                                {relatedStatus.provisional_degree_courier_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">Provisional Degree Courier:</span>
                                    <p className="text-gray-600 mt-1">{relatedStatus.provisional_degree_courier_status}</p>
                                  </div>
                                )}
                                {relatedStatus.recommendation_letter_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">Recommendation Letter:</span>
                                    <p className="text-gray-600 mt-1">{relatedStatus.recommendation_letter_status}</p>
                                  </div>
                                )}
                                {relatedStatus.result_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">Result:</span>
                                    <p className="text-gray-600 mt-1">{relatedStatus.result_status}</p>
                                  </div>
                                )}
                                {relatedStatus.roll_no_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">Roll No.:</span>
                                    <p className="text-gray-600 mt-1">{relatedStatus.roll_no_status}</p>
                                  </div>
                                )}
                                {relatedStatus.university_phd_offer_letter_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">University PhD Offer Letter:</span>
                                    <p className="text-gray-600 mt-1">{relatedStatus.university_phd_offer_letter_status}</p>
                                  </div>
                                )}
                                {relatedStatus.university_visit_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">University Visit:</span>
                                    <p className="text-gray-600 mt-1">{relatedStatus.university_visit_status}</p>
                                  </div>
                                )}
                                {relatedStatus.university_visit1_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">University Visit 1:</span>
                                    <p className="text-gray-600 mt-1">{relatedStatus.university_visit1_status}</p>
                                  </div>
                                )}
                                {relatedStatus.university_visit2_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">University Visit 2:</span>
                                    <p className="text-gray-600 mt-1">{relatedStatus.university_visit2_status}</p>
                                  </div>
                                )}
                                {relatedStatus.university_visit3_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">University Visit 3:</span>
                                    <p className="text-gray-600 mt-1">{relatedStatus.university_visit3_status}</p>
                                  </div>
                                )}
                                {relatedStatus.viva_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">VIVA:</span>
                                    <p className="text-gray-600 mt-1">{relatedStatus.viva_status}</p>
                                  </div>
                                )}
                                {relatedStatus.wes_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">WES:</span>
                                    <p className="text-gray-600 mt-1">{relatedStatus.wes_status}</p>
                                  </div>
                                )}
                              </div>
                              {relatedStatus.notes && (
                                <div className="mt-3 text-sm">
                                  <span className="font-semibold text-gray-700">University Status Notes:</span>
                                  <p className="text-gray-600 mt-1 bg-white p-3 rounded">{relatedStatus.notes}</p>
                                </div>
                              )}
                            </div>
                          )}
                          ...
                          <div className="flex gap-3">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mt-4">
                                {status.courseware_exam_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">Courseware Exam:</span>
                                    <p className="text-gray-600 mt-1">{status.courseware_exam_status}</p>
                                  </div>
                                )}
                                {status.degree_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">Degree:</span>
                                    <p className="text-gray-600 mt-1">{status.degree_status}</p>
                                  </div>
                                )}
                                {status.enrolment_no_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">Enrolment No.:</span>
                                    <p className="text-gray-600 mt-1">{status.enrolment_no_status}</p>
                                  </div>
                                )}
                                {status.exam_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">Exam:</span>
                                    <p className="text-gray-600 mt-1">{status.exam_status}</p>
                                  </div>
                                )}
                                {status.lor_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">LOR:</span>
                                    <p className="text-gray-600 mt-1">{status.lor_status}</p>
                                  </div>
                                )}
                                {status.ms_hard_copy_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">MS Hard Copy:</span>
                                    <p className="text-gray-600 mt-1">{status.ms_hard_copy_status}</p>
                                  </div>
                                )}
                                {status.ms_hard_copy_courier_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">MS Hard Copy Courier:</span>
                                    <p className="text-gray-600 mt-1">{status.ms_hard_copy_courier_status}</p>
                                  </div>
                                )}
                                {status.ms_scan_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">MS SCAN:</span>
                                    <p className="text-gray-600 mt-1">{status.ms_scan_status}</p>
                                  </div>
                                )}
                                {status.provisional_degree_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">Provisional Degree:</span>
                                    <p className="text-gray-600 mt-1">{status.provisional_degree_status}</p>
                                  </div>
                                )}
                                {status.provisional_degree_courier_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">Provisional Degree Courier:</span>
                                    <p className="text-gray-600 mt-1">{status.provisional_degree_courier_status}</p>
                                  </div>
                                )}
                                {status.recommendation_letter_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">Recommendation Letter:</span>
                                    <p className="text-gray-600 mt-1">{status.recommendation_letter_status}</p>
                                  </div>
                                )}
                                {status.result_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">Result:</span>
                                    <p className="text-gray-600 mt-1">{status.result_status}</p>
                                  </div>
                                )}
                                {status.roll_no_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">Roll No.:</span>
                                    <p className="text-gray-600 mt-1">{status.roll_no_status}</p>
                                  </div>
                                )}
                                {status.university_phd_offer_letter_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">University PhD Offer Letter:</span>
                                    <p className="text-gray-600 mt-1">{status.university_phd_offer_letter_status}</p>
                                  </div>
                                )}
                                {status.university_visit_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">University Visit:</span>
                                    <p className="text-gray-600 mt-1">{status.university_visit_status}</p>
                                  </div>
                                )}
                                {status.university_visit1_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">University Visit 1:</span>
                                    <p className="text-gray-600 mt-1">{status.university_visit1_status}</p>
                                  </div>
                                )}
                                {status.university_visit2_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">University Visit 2:</span>
                                    <p className="text-gray-600 mt-1">{status.university_visit2_status}</p>
                                  </div>
                                )}
                                {status.university_visit3_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">University Visit 3:</span>
                                    <p className="text-gray-600 mt-1">{status.university_visit3_status}</p>
                                  </div>
                                )}
                                {status.viva_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">VIVA:</span>
                                    <p className="text-gray-600 mt-1">{status.viva_status}</p>
                                  </div>
                                )}
                                {status.wes_status && (
                                  <div className="text-sm bg-white p-2 rounded border border-gray-200">
                                    <span className="font-semibold text-gray-700">WES:</span>
                                    <p className="text-gray-600 mt-1">{status.wes_status}</p>
                                  </div>
                                )}
                              </div>
